                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col d-flex flex-column flex-sm-row justify-content-between mb-3">
                                            <div class="text-center text-sm-left mb-2 mb-sm-0">
                                                <h4 class="pt-sm-2 pb-1 mb-0 text-nowrap" style="color:black;"><?php echo $_SESSION['fname']; echo $_SESSION['lname']; ?></h4>
                                                <p class="mb-0" style="color: black;">@<?php echo $_SESSION['username']; ?></p>
                                                    <div class="text-muted"><small>Last seen 2 hours ago</small></div>
                                                        ...
                                                        <label for="input-file" style="color: white; display: block; width: 180px; background: #2759ff; padding: 10px; margin: 10px auto; border-radius: 5px; cursor: pointer; text-align: center;">Change Photo</label>
                                                        </div>
                                                    </div>
                        ...
                        <div class="row">
                          <div class="col">
                            <div class="form-group">
                              ...
                              <input class="form-control" type="text" name="name" placeholder="Enter Name" value="<?php echo $_SESSION['fname']; echo $_SESSION['lname']; ?> ">
                            </div>
                          </div>
                          <div class="col">
                            <div class="form-group">
